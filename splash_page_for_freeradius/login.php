...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($response === false) {
        ...
        // IP adresini almak için $_SERVER değişkenini kullanın
        ...
        $iptablesCommand = "sudo iptables -t mangle -I internet 1 -m mac --mac-source " . trim($macAddress) . " -j RETURN";
        exec($iptablesCommand);

        // Kısıtlamanın kaldırıldığına dair mesajı görüntüleyin
        $result .= "<br>Kısıtlama kaldırıldı. MAC adres: $macAddress, IP adres: $ipAddress";
